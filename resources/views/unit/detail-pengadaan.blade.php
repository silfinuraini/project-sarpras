...
@section('content')
    <main class="h-full overflow-y-auto">
        <div class="container my-4 px-6 mx-auto grid">
            ...
            {{-- Nota Barang Start --}}
            <div class="min-w-0 p-4 bg-white border border-gray-300 shadow-md rounded-box dark:bg-gray-800">
                ...
                <div class="grid mt-2 md:grid-cols-4">
                    ...
                    <div class="col-span-3 px-4 justify-center items-center">
                        <input type="text" placeholder="" value=": {{ $pengadaan->sifat }}" name="sifat"
                    ...
                    <div class="col-span-3 px-4 justify-center items-center">
                        <textarea type="text" placeholder="" name="perihal" value="{{ $pengadaan->perihal }}"
                            ...
                            fdprocessedid="dee09r" readonly>: {{ $pengadaan->perihal }}</textarea>
                    </div>
                </div>
            </div>
            {{-- Nota Barang End --}}
