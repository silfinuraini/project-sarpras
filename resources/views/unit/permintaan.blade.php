            ...
            <main class="h-full overflow-y-auto">
                <div class="container my-4 px-6 mx-auto grid">
                    ...
                    <form action="{{ route('permintaan.store') }}" method="POST">
                        ...
                        {{-- Nota Start --}}
                        <div
                            class="min-w-0 p-4 bg-white border border-gray-300 shadow-md rounded-box shadow-xs dark:bg-gray-800">
                        ...
                        {{-- List Items Start --}}
                        <div
                            class="items-center mt-4 p-4 bg-white rounded-box border border-gray-300 shadow-md dark:bg-gray-800">
                            <div class="label">
