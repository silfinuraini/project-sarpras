...
<body>
    ...
    <p>Dengan ini kami sampaikan laporan barang masuk sebagai berikut:</p>
        ...
        <tbody>
            @foreach ($barangMasuk as $index => $bm)
                <tr>
                    ...
                    <td style="font-size: 13px; text-align: center">{{ $bm->kode }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $bm->pegawai->nama ?? '' }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $bm->jumlah_item ?? '' }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $bm->supplier->nama ?? '' }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $bm->created_at->format('d-m-Y') ?? '' }}</td>
