    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <td style="font-size: 13px; text-align: center">HARGA</td>
                <td style="font-size: 13px; text-align: center">STOK</td>
                <td style="font-size: 13px; text-align: center">STOK MINIMUM</td>
        ...
        <tbody>
            @foreach ($items as $index => $item)
                <tr>
                    ...
                    <td style="font-size: 13px; text-align: center">{{ $item->kategori->nama ?? '' }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $item->merk ?? '' }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $item->harga ?? '' }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $item->stok ?? '' }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $item->stok_minimum ?? '' }}</td>
