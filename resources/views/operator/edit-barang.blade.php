                ...
                <form action="{{ route('item.update', $items->kode) }}" method="POST">
                    ...
                    <div class="px-4 py-3 mb-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <div class="grid ms-4 mt-2 md:grid-cols-4">
                            ...
                            <div>
                                <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                                    ...
                                    <p class="text-gray-700 text-sm dark:text-gray-400">
                                        Format foto harus .jpg .jpeg .png dan ukuran min. 300 x 300 px (untuk gambar
                                        optimal,
                            ...
                            <div class="p-4 col-span-3 justify-center items-center">
                                <input type="text" name="nama" value="{{ $items->nama }}"
                            ...
                            <div class="p-4 col-span-3 justify-center items-center">
                                <input type="text" name="merk" value="{{ $items->merk }}"
                                    class="input text-sm  input-bordered w-full text-gray-700 bg-white" />
                            </div>
                            <div>
                                <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                            ...
                            <div class="p-4 col-span-3 justify-center items-center">
                                <input type="text" value="{{ $items->jenis }}" name="jenis"
                                    class="input text-sm  input-bordered w-full text-gray-700 bg-white" />
                            </div>
                            <div>
                                <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                            ...
                            <div class="p-4 col-span-3 justify-center items-center">
                                <input type="text" value="{{ $items->ukuran }}" name="ukuran"
                                    class="input text-sm  input-bordered w-full text-gray-700 bg-white" />
                            </div>
                            <div>
                                <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                            ...
                            <div class="p-4 col-span-3 justify-center items-center">
                                <input type="text" value="{{ $items->warna }}" name="warna"
                                    class="input text-sm  input-bordered w-full text-gray-700 bg-white" />
                            </div>
                            <div>
                                <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                            ...
                            <div class="p-4 col-span-3 justify-center items-center">
                                <textarea name="deskripsi" class="textarea h-full textarea-bordered bg-white text-gray-800 text-sm w-full"
                                    placeholder="">{{ $items->deskripsi }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-4 py-3 mb-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <div class="grid ms-4 mt-2 md:grid-cols-3">
                            ...
                            <div class="p-4">
                                <div class="form-control w-full relative">
                                    <input type="text" placeholder=" " name="stok" value="{{ $items->stok }}"
                                        class="input text-sm bg-white text-gray-800 input-bordered w-full pt-4 pb-1" />
                                    <label
