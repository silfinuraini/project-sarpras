                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    <div class="flex justify-center items-center space-x-4 text-sm">
                                                        {{-- @if ($pegawai->status == 'menunggu') --}}
                                                        <button
                                                            onclick="document.getElementById('modal-{{ $dp->kode_pengadaan }}').showModal()"
                                                        ...
                                                        <!-- Modal -->
                                                        <dialog id="modal-{{ $dp->kode_pengadaan }}" class="modal">
                                                            <div class="modal-box bg-white text-gray-800">
                                                                ...
                                                                <div class="flex gap-2">
                                                                    <input type="number" value="{{ $dp->kuantiti }}"
