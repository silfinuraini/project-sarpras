                ...
                <dialog id="formTambah" class="modal">
                    <div class="modal-box bg-gray-100 text-gray-700">
                        ...
                        <form action="{{ route('barangmasuk.store') }}" method="POST">
                            @csrf
                            <label class="input w-full input-bordered flex focus:outline-none items-center mb-2 bg-white text-gray-700">
                                ...
                                <select name="kode_supplier" class="bg-white ms-2 outline-none border-none text-sm w-full text-gray-700">
                            ...
                            <div class="items-center p-4 bg-white rounded-box shadow-xs dark:bg-gray-800">
                                ...
                                <div class="justify-center flex">
                                    <button type="button" id="add-form-row" class="mt-4 px-4 py-2 text-sm font-medium leading-5 text-purple-600 hover:text-white active:text-white transition-colors duration-150 bg-transparent border border-purple-600 rounded-box active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" style="width: 60%;">
                                        Tambah form
                                    </button>
                                </div>
                            </div>
                            <button type="submit" class="w-full my-2 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-box active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                Buat
                            </button>
                        </form>
                    </div>
