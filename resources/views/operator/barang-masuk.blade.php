        ...
        <div class="container my-4 px-6 mx-auto grid">
            ...
            <div class="flex gap-2">
                ...
                <select id="categoryFilter"
                    class="select select-bordered max-w-xs bg-white text-gray-700 shadow-md ml-auto">
                    ...
                    <div class="flex items-center justify-between mb-2">
                        <p class="mt-1">
                         ...
                         <div class="dropdown dropdown-end dropdown-hover ml-auto">
                            ...
                            <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                                <li><a href="{{ route('barangmasuk.detail.excel', ['kode' => $bm->kode]) }}">Excel</a></li>
                                <li><a href="{{ route('barangmasuk.detail.pdf', ['kode' => $bm->kode]) }}">PDF</a></li>
                            </ul>
                        </div>
