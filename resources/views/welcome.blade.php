                                    ...
                                    <div class="flex gap-2">
                                        <button onclick="detailBarang{{ $item->kode }}.showModal()" type="button"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19"
                                                fill="none" class=" opacity-70" viewBox="0 0 24 24" stroke="white"
                                                ...
                                                <div class="grid grid-cols-2 ">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p
                                                            class="text-gray-800 text-xs dark:text-gray-400 flex gap-1 mb-1">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="currentColor" class="bi bi-puzzle"
                                                                viewBox="0 0 16 16">
                                                                <path
                                                        ...
                                                        <div
                                                            ...
                                                            <table class="my-2">
                                                                <tr class="text-gray-800 text-xs dark:text-gray-400 mb-1">
